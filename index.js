...
/////////////////
const BotName = 'BOT KhuzaifiGans'; 
const instagram = 'Blom di buat'; 
const telegram = 'Blom di buat'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by KhuzaifiGans')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Khuzaifi.id`)
})
